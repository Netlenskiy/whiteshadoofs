...
INSERT INTO `auth_user` VALUES (1,'pbkdf2_sha256$20000$KoKvrP3a54hQ$PAeEkbTCLtbSdxfuRIwECBGFxM98d/cEGbVwGYjBj5g=','2016-01-09 11:23:29',1,'root','','','netlenskiy@yandex.ru',1,1,'2015-12-06 17:52:49');
...
CREATE TABLE `ws_geo_object` (
  ...
  `object_id` int(11) DEFAULT NULL,
  `gallery_link_id` int(11),
  PRIMARY KEY (`id`),
  KEY `ws_geo_object_af31437c` (`object_id`),
  KEY `ws_geo_object_b3856a71` (`gallery_link_id`),
  CONSTRAINT `ws_geo_object_gallery_link_id_2b3655f2a66aff78_fk_ws_imageset_id` FOREIGN KEY (`gallery_link_id`) REFERENCES `ws_imageset` (`id`),
...
INSERT INTO `ws_geo_object` VALUES (6,'вапродж','апролдэ',58.244306,42.930191,'ws/2015/12/13/images_080qET9.jpg',30,NULL);
...
-- Dump completed on 2016-01-09 15:14:54
