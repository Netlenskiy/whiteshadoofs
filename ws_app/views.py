...
from ws_app import models, forms
...
def objects_search(request):
    ...
    template = 'ws_app/ws_app/templates/ws_app/search/search_result.html'
...
def fetch_placemarks(request):
    ...
    response = render(request, 'ws_app/templates/pms.json', {'func': callback, 'bbox': geo_objects})
    return response
